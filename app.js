        ...
        dbObj.transaction(function (tx) {
            ...
            tx.executeSql('insert into deptTable(did, dName, estd) values(2,"Accountant","' + today + '")');  
            tx.executeSql('insert into deptTable(did, dName, estd) values(3,"Claerk","' + today + '")');  
            tx.executeSql('insert into deptTable(did, dName, estd) values(4,"Management","' + today + '")');  
